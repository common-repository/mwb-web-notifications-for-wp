...
$main_args = array(
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'Email Invites', 'mwb-web-notifications-for-wp' ),
			),
			array(
	...
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'Congratulations to you get dribble invitation code. looking forward to seeing your first show.', 'mwb-web-notifications-for-wp' ),
	...
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'Catch It', 'mwb-web-notifications-for-wp' ),
	...
	array(
		...
		'callback_args' => $this->mwnfw_choose_image_to_upload( MWB_WEB_NOTIFICATIONS_FOR_WP_DIR_URL . '/admin/image/invite.png' ),
	),
	array(
