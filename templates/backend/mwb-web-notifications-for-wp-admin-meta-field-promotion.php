...
$main_args = array(
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'On New Products', 'mwb-web-notifications-for-wp' ),
	...
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'Use Code', 'mwb-web-notifications-for-wp' ),
	...
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'PROMOTIONAL CODE', 'mwb-web-notifications-for-wp' ),
			),
			array(
	...
	array(
		...
		'title' => __( 'Enter Discount (%)', 'mwb-web-notifications-for-wp' ),
		'callback_args' => array(
			array(
	...
	array(
		...
		'title' => __( 'Enter Coupon Code', 'mwb-web-notifications-for-wp' ),
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'ABC50OFF', 'mwb-web-notifications-for-wp' ),
	...
	array(
		...
		'callback_args' => array(
			...
			array(
				'id'            => 'mwb_mwnfw_notification_coupon_text_color',
				'label'         => __( 'Choose Coupon text Color.', 'mwb-web-notifications-for-wp' ),
				'value'         => get_post_meta( get_the_ID(), 'mwb_mwnfw_notification_coupon_text_color', true ),
				'default_val'   => '',
				'type'          => 'text',
				'class'         => 'mwb-mwnfw-color-picker__dyanmic',
			...
			array(
				'id'            => 'mwb_mwnfw_notification_discount_color',
				'label' => __( 'Choose Discount Color.', 'mwb-web-notifications-for-wp' ),
				'value'         => get_post_meta( get_the_ID(), 'mwb_mwnfw_notification_discount_color', true ),
				'default_val'   => '',
				'type'          => 'text',
				'class'         => 'mwb-mwnfw-color-picker__dyanmic',
			),
	...
	array(
		...
		'callback_args' => $this->mwnfw_choose_image_to_upload( MWB_WEB_NOTIFICATIONS_FOR_WP_DIR_URL . '/admin/image/promotion.png' ),
	),
	array(
