...
$main_args = array(
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'Success', 'mwb-web-notifications-for-wp' ),
			),
			array(
	...
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'Ok', 'mwb-web-notifications-for-wp' ),
			),
		),
	...
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'Check you your email for a booking confirmation. We will see you soon!', 'mwb-web-notifications-for-wp' ),
			),
		),
	),
	array(
	...
	array(
		...
		'callback_args' => $this->mwnfw_choose_image_to_upload( MWB_WEB_NOTIFICATIONS_FOR_WP_DIR_URL . '/admin/image/success.png' ),
	),
	array(
