...
$main_args = array(
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'New', 'mwb-web-notifications-for-wp' ),
			),
			array(
	...
	array(
		'id' => 'mwb-mwnfw-popup-sub-title-text',
		'title' => __( 'Enter pop-up sub-title', 'mwb-web-notifications-for-wp' ),
		'callback_args' => array(
			array(
				'id'            => 'mwb_mnfw_popup_sub_title',
				'value'         => get_post_meta( get_the_ID(), 'mwb_mnfw_popup_sub_title', true ),
				'placeholder'   => __( 'Enter Sub-title', 'mwb-web-notifications-for-wp' ),
				'type'          => 'text',
				'default_val'   => __( 'Arrivals', 'mwb-web-notifications-for-wp' ),
	...
	array(
		'id' => 'mwb-mwnfw-popup-product-details-text',
		'title' => __( 'Enter product details', 'mwb-web-notifications-for-wp' ),
		'callback_args' => array(
			array(
				'id'            => 'mwb_mwnfw_product_details_text',
				'value'         => get_post_meta( get_the_ID(), 'mwb_mwnfw_product_details_text', true ),
				'placeholder'   => __( 'Enter Product related text here', 'mwb-web-notifications-for-wp' ),
				'default_val'   => __( 'In Running Shoes', 'mwb-web-notifications-for-wp' ),
				'type'          => 'text',
			),
		),
	),
	...
	array(
		...
		'callback_args' => array(
			...
			array(
				...
				'label' => __( 'Choose Content Heading Color.', 'mwb-web-notifications-for-wp' ),
			...
			array(
				'id'            => 'mwb_mwnfw_notification_product_details_color',
				'label' => __( 'Choose Product details Color.', 'mwb-web-notifications-for-wp' ),
				'value'         => get_post_meta( get_the_ID(), 'mwb_mwnfw_notification_product_details_color', true ),
				'type'          => 'text',
				'default_val'   => '',
				'class'         => 'mwb-mwnfw-color-picker__dyanmic',
	...
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'CHECK THEM OUT', 'mwb-web-notifications-for-wp' ),
	...
	array(
		...
		'callback_args' => array(
			array(
				...
				'type'          => 'text',
				'default_val'   => __( 'We Think You Will Love Them', 'mwb-web-notifications-for-wp' ),
	...
	array(
		...
		'callback_args' => $this->mwnfw_choose_image_to_upload( MWB_WEB_NOTIFICATIONS_FOR_WP_DIR_URL . '/admin/image/propensity.jpg' ),
	),
	array(
